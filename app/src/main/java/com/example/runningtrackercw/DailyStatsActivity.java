...
public class DailyStatsActivity extends AppCompatActivity {
    ...
    public void queryExercises(int sort) {
        ...
        // Get the current date and format it to facilitate getting current day
        SimpleDateFormat dateFormatter = new SimpleDateFormat("dd/MM/yyyy");
        Date currentDate = new Date();
        String date = dateFormatter.format(currentDate);
        // Display the date
        TextView dateView = findViewById(R.id.textView47);
        dateView.setText(date);
        // The cursor returned from the query with the selection by day
        ...
        // If no exercise done today (i.e database empty where date is today) return
        if (numEntries == 0)
            return;
        ...
        // Split the concatenated image string into individual strings
        ...
        // Store the sum of all the times as a float
        float sumTime = 0;
        ...
        TextView bestDistanceField = findViewById(R.id.textView52);
        bestDistanceField.setText(bestDistance + " m");
        TextView totalDistanceField = findViewById(R.id.textView43);
        totalDistanceField.setText(totalDistance + " m");
        TextView totalTimeField = findViewById(R.id.textView46);
        totalTimeField.setText(totalTime);
        TextView bestTimeField = findViewById(R.id.textView50);
        ...
        dataAdapter = new SimpleCursorAdapter(
                ...
                0);
        // Set up the listView
        ListView listView = findViewById(R.id.dailyListView);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View view, int position, long arg3) {
                ...
                Intent intent = new Intent(DailyStatsActivity.this, SingleExerciseStatsActivity.class);
